...
public class Digraph {
	...
	//// constructors
	/**
	 * Constructs a digraph from a list of pairs. A pair (A,B) is transformed into
	 * vertices A and B together with a directed edge A->B.
	 */
	...
	public List<Vertex> reachable(Vertex u) {
		ReachableVertices rvertices = new ReachableVertices(this);
		return rvertices.reachable(u);
	}
	...
	/**
	 * Returns a List of vertices in topological order. Precondition: this G is a
	 * DAG (i.e. no directed cycles) and all vertices are reachable from the start
	 * vertex. If not all are reachable, then returns list of all vertices reachable
	 * from start vertex, in topological order. Otherwise, throws
